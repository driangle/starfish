...
- [x] Create `docs/cookbook/pool-auto-pairing.md` — **Random pairing with auto mode**
...
- [x] Create `docs/cookbook/pool-filtered-matching.md` — **Attribute filtering**
...
- [x] Create `docs/cookbook/pool-delegated-matchmaker.md` — **Custom matchmaker with delegated mode**
...
- [x] Create `docs/cookbook/pool-repaired-on-disconnect.md` — **Re-pairing when a peer disconnects**
