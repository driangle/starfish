...
test-sdk-typescript-python: ## Run TypeScript SDK integration tests against the Python server
	@./scripts/run-sdk-integration-tests.sh typescript python

test-sdk-typescript: test-sdk-typescript-golang test-sdk-typescript-typescript test-sdk-typescript-python ## Run TypeScript SDK integration tests against all servers
...
test-sdk-python-python: ## Run Python SDK integration tests against the Python server
	@./scripts/run-sdk-integration-tests.sh python python
...
test-sdk-golang: test-sdk-golang-typescript ## Run Go SDK integration tests against all servers
